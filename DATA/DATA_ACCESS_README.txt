...
## POPULATION DATA
POPULATIONS.csv: yearly data downloaded at "https://population.un.org/wpp/downloads?folder=Standard%20Projections&group=CSV%20format", using data type '1950-2100, medium (gz)'

## POSITIVE PEACE INDEX DATA
PPI_2009_2002.csv: yearly data was requested from info@economicsandpeace.org. Data column labeled 'PPI.Overall.Score' was copied and used for analysis.

## CO2 EMISSIONS DATA
co2_ghg.csv: yearly data downloaded at "https://github.com/owid/co2-data", which links to portal page "https://ourworldindata.org/co2-and-greenhouse-gas-emissions". Data column labeled 'co2_per_capita' used for analysis.
